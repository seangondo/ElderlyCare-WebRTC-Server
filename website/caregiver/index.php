...
<body onload="">
    ...
    <div class="main-content">
        <div class="card">
            ...
            <form method="post" action="webrtc.php">
                <div class="center">
                ...
                <div class="center">
                    <input class="inpt" type="text" name="elder" placeholder="Elder ID">
                    <p style="color: red"> <?php if($errorPass){ echo "Elder ID empty!";} else {echo "";}?> </p>
                </div>
                <div class="center">
