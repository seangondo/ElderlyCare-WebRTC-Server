...
class Constants {
	...
	const PLATFORM_ENV_VAR = "AcceptChPlatformKey";
	const HARDWARE_ENV_VAR = "AcceptChHardwareKey";
	const BROWSER_ENV_VAR = "AcceptChBrowserKey";
	const NO_ACCEPTCH_ENV_VAR = "AcceptChNoneKey";
